...
pub fn role_card(id: RoleId) -> RoleCard {
    match id {
        RoleId::Analyst => RoleCard {
            ...
            reads_en: "the customer's notes and discovery notes; your company profile",
            reads_zh: "客户备注和需求笔记;你的公司资料",
            delivers_en: "a discovery summary appended to the customer's discovery notes after you approve it",
            delivers_zh: "经你批准后追加到客户需求笔记里的需求整理",
            cannot_en: "turn a guess into a customer-confirmed fact",
            cannot_zh: "把猜测当作客户确认过的事实",
        },
        RoleId::ProposalWriter => RoleCard {
            ...
            reads_en: "the customer's discovery summary and notes; your service description",
            reads_zh: "客户的需求整理和备注;你的服务描述",
            delivers_en: "a draft offer you can edit, then send through the usual approval",
            delivers_zh: "一份可编辑的报价草稿,之后走正常的发送审批",
            cannot_en: "promise a price or date to the customer, or send anything",
            cannot_zh: "向客户承诺价格或日期,或发送任何内容",
        },
        RoleId::DeliveryPlanner => RoleCard {
            ...
            reads_en: "the accepted offer and the customer's discovery summary",
            reads_zh: "已接受的报价和客户的需求整理",
            delivers_en: "a project plan you approve before any task exists",
            delivers_zh: "一份项目计划,经你批准后才会生成任务",
            cannot_en: "change the agreed scope or mark work as done",
            cannot_zh: "改变约定的范围,或把工作标记为完成",
        },
        RoleId::InvoiceClerk => RoleCard {
            ...
            reads_en: "the finished project, its offer amount, and your registration facts",
            reads_zh: "已完成的项目、报价金额和你的注册信息",
            delivers_en: "a draft invoice you review and send through the usual approval",
            delivers_zh: "一份发票草稿,由你审阅后走正常的发送审批",
            cannot_en: "issue, send, or collect anything",
            cannot_zh: "开具、发送或收取任何款项",
        },
        RoleId::QualityChecker => RoleCard {
            ...
            reads_en: "one draft document and the customer it is for",
            reads_zh: "一份草稿及其对应的客户",
            delivers_en: "findings you acknowledge; the draft itself is never edited",
            delivers_zh: "由你确认的检查发现;草稿本身不会被修改",
            cannot_en: "approve on your behalf or grant any other employee authority",
            cannot_zh: "替你批准,或授予其他员工任何权限",
        },
        RoleId::ComplianceChecker => RoleCard {
            ...
            reads_en: "your registration facts, customers' locations, and issued invoices",
            reads_zh: "你的注册信息、客户所在地和已开具的发票",
            delivers_en: "a report with pass / attention / needs-review findings and citations",
            delivers_zh: "一份报告:通过 / 需处理 / 需复核,每条附引用来源",
            cannot_en: "declare anything fully compliant, or replace a licensed professional",
            cannot_zh: "宣称完全合规,或替代持牌专业人士",
        },
    }
}
